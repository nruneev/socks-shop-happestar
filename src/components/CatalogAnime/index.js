...
const CatalogAnimeList = ({ items, setMenu, activeTags, activeSizes, toggleSize, sizes }) => {
    ...
    return (
        <div className=''>
            <div className="mobileTopCatalog animeMobile">
                <div className='linker mobile'>
                    <ul>
                        <li><a href={'./'}>Главная</a></li>
                        <li><a onClick={() => history.goBack()}>Назад</a></li>
                        <li><span>ANIME COLLECTION</span></li>
                    </ul>
